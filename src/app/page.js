...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard" style={{ maxWidth: "100%", overflowX: "hidden" }}>
      ...
      <div className="widget-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 400px), 1fr))", gap: "1.5rem" }}>
        ...
        <div className="widget card" style={{ gridColumn: "1 / -1", minWidth: 0 }}>
          <div className="widget-header">
            <div>
          ...
          <div className="widget-content" style={{ maxHeight: "1000px", overflowY: "auto", overflowX: "hidden" }}>
            <p style={{ fontSize: "0.75rem", marginBottom: "1rem", color: "var(--text-secondary)" }}>
               ...
               <div className="report-main-grid">
                 ...
                 <div style={{ minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem", borderBottom: "1px solid rgba(255,255,255,0.1)", paddingBottom: "0.5rem", flexWrap: "wrap", gap: "1rem" }}>
                       ...
                       <div style={{ display: "flex", gap: "0.6rem", fontSize: "0.6rem", flexWrap: "wrap" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
                       {Object.entries(
                         ...
                         <div key={part}>
                           <h4 style={{ fontSize: "0.85rem", color: "var(--accent-color)", marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                               ...
                               return (
                                 <div key={idx} style={{ 
                                   ...
                                   <div style={{ display: "flex", flexDirection: "column", minWidth: 0 }}>
                                     <span style={{ fontSize: "0.85rem", fontWeight: "bold", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", color: "var(--text-primary)" }}>{u.author}</span>
                                     <div style={{ display: "flex", alignItems: "center", gap: "0.3rem" }}>
                                        <span style={{ fontSize: "0.75rem", color: color, fontWeight: "800" }}>{u.totalHours.toFixed(1)}H</span>
